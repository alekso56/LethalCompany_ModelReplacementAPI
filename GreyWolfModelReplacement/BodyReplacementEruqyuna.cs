...
{
    public class BodyReplacementEruqyuna : BodyReplacementBase
    {
        public override string boneMapFileName => "Bonesctructure_Eruqyuna2_Morioh.json";

        public override GameObject LoadAssetsAndReturnModel()
        {
            return LC_API.BundleAPI.BundleLoader.GetLoadedAsset<GameObject>("assets/avatars/eruqyuna2/eruqyuna2_morioh_edit_n7hoodie.prefab");
        }
